...
import {
  ...
  FiEdit2, FiSave, FiX, FiLock, FiCheck, FiBook, FiImage
} from 'react-icons/fi'
...
const StudentProfile = () => {
  ...
  const getRoleColor = (role) => {
    const colors = {
      ...
      'teacher': { bg: 'rgba(139, 92, 246, 0.1)', color: '#8b5cf6' },
      'admin': { bg: 'rgba(239, 68, 68, 0.1)', color: '#ef4444' },
      'administrator': { bg: 'rgba(239, 68, 68, 0.1)', color: '#ef4444' },
      'club_manager': { bg: 'rgba(16, 185, 129, 0.1)', color: '#10b981' }
    }
    return colors[role] || { bg: '#f3f4f6', color: '#6b7280' }
  }
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', position: 'relative', zIndex: 1, flexWrap: 'wrap' }}>
            ...
            <div style={{ position: 'relative' }}>
              ...
              >
                <FiImage size={16} style={{ color: 'var(--primary-blue)' }} />
              </button>
            </div>
            <div style={{ flex: 1 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                ...
                <div>
                  ...
                  <div style={{ fontWeight: '500' }}>{getRoleLabel(user?.role)}</div>
                </div>
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(250px, 1fr))', gap: '1rem' }}>
                {user.modules.map((module, idx) => (
                  <div key={idx} style={{
                    ...
                    <div style={{ fontWeight: '600', marginBottom: '0.25rem' }}>{module.label}</div>
                    <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>{module.description}</div>
                  </div>
                ))}
              </div>
            </motion.div>
