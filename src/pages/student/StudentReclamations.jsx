...
import {
  ...
  FiTrash2, FiEye, FiUpload, FiLock, FiUnlock, FiMessageCircle,
  FiSend, FiUser
} from 'react-icons/fi'
...
const StudentReclamations = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData({ category: 'AUTRES', description: '', is_anonymous: false, file: null })
      loadReclamations()
    } catch (error) {
            ...
            >
              ...
              <div className="detail-content">
                ...
                <div className="conversation-container" style={{
                  ...
                  {/* Original Message */}
                  <div className="message-bubble sent" style={{
                    ...
                    selectedReclamation.history.map((item, idx) => (
                      <div key={idx}>
                        ...
                        <div style={{
                          ...
                          Statut changé en <strong>{reclamationService.getStatusLabel(item.status)}</strong>
                          {' • '}{new Date(item.created_at).toLocaleString('fr-FR')}
                        </div>

                        {/* Admin Comment/Response */}
                        {item.comment && (
                          <div className="message-bubble received" style={{
                            background: 'white',
